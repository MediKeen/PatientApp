...
public class Camera2Fragment extends Fragment implements View.OnClickListener,
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        mFile = new File(GridViewDemo_ImagePath, dateFormat.format(new Date())
                + ".jpg");
    }
    ...
    public void onRequestPermissionsResult(int requestCode,
        ...
        if (requestCode == REQUEST_CAMERA_PERMISSION) {
            if (grantResults.length != 1
                ...
                ErrorDialog.newInstance("Permission for using camera").show(
                        getChildFragmentManager(), FRAGMENT_DIALOG);
            }
        }
    }
    ...
    private void setUpCameraOutputs(int width, int height) {
        ...
        try {
            for (String cameraId : manager.getCameraIdList()) {
                ...
                Integer facing = characteristics
            ...
            ErrorDialog.newInstance("Camera Error").show(
                    getChildFragmentManager(), FRAGMENT_DIALOG);
        }
    }
