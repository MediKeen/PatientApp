...
public class AutoFitTextureView extends TextureView {
	 ...
	 * measured based on the ratio calculated from the parameters. Note that the
	 * actual sizes of parameters don't matter, that is, calling
