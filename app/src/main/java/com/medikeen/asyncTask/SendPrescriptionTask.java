...
public class SendPrescriptionTask extends AsyncTask<PrescriptionModel, String, String> {
    ...
    public SendPrescriptionTask(HomePage homePage) {
        _send = homePage;
    }
    ...
    @Override
    protected String doInBackground(PrescriptionModel... params) {
        // TODO Auto-generated method stub
